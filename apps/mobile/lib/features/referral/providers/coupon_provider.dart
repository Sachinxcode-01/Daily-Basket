...
class CouponProvider extends ChangeNotifier {
  ...
  final List<Coupon> _allCoupons = [
    Coupon(
      ...
      subtitle: 'Flat ₹100 OFF on your first order above ₹299.',
      discountDisplay: '₹100',
      discountSub: 'OFF',
    ...
    Coupon(
      ...
      subtitle: '20% OFF up to ₹80 on fresh produce orders above ₹199.',
      discountDisplay: '20%',
      discountSub: 'OFF',
      discountBg: const Color(0xFFE0F2F1),
      discountColor: const Color(0xFF00796B),
    ...
    Coupon(
      id: 'c_freedel',
      code: 'FREEDEL',
      title: 'Free Express 10-Min Delivery',
      subtitle: 'Free delivery on all orders above ₹149.',
    ...
    Coupon(
      ...
      subtitle: 'Flat ₹50 OFF on grocery essentials above ₹399.',
      discountDisplay: '₹50',
      discountSub: 'OFF',
      discountBg: const Color(0xFFE3F2FD),
      discountColor: const Color(0xFF1976D2),
      expiry: 'VALID TILL SEP 30',
    ...
    Coupon(
      ...
      subtitle: 'Get flat ₹10 cashback on milk & cheese orders over ₹30.',
      discountDisplay: '₹10',
    ...
    Coupon(
      ...
      subtitle: 'Flat ₹100 discount on orders above ₹300.',
      discountDisplay: '₹100',
      discountSub: 'OFF',
      discountBg: const Color(0xFFE3F2FD),
