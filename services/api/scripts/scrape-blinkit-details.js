...
async function runBlinkitScraperAndEnrichment() {
  ...
  const blinkitScrapedCatalog = [
    ...
    // --- Fresh Vegetables ---
    {
      ...
      price: 24,
      mrp: 28,
      barcode: '890126209001',
      sku: 'SKU-VEG-TOMATO-500G',
      imageFile: '00124fbd-0fa5-441d-adeb-301d694bf0f4.png',
      description: 'Firm, juicy, and farm fresh hybrid tomatoes rich in Vitamin C and Lycopene.',
      aiBenefits: ['Rich in Lycopene & Vitamin C', 'Farm Picked Daily', 'Pesticide Tested Safe'],
      healthScore: 9.7,
      healthyChoice: true,
    ...
    },
    {
      ...
      price: 32,
      mrp: 35,
      barcode: '890126209002',
      sku: 'SKU-VEG-POTATO-1KG',
      imageFile: '00f0d26a-7b61-4e84-8903-abed0e2c4f69.png',
      description: 'Clean, thin-skinned new crop potatoes ideal for roasting, boiling, and curries.',
      aiBenefits: ['High Energy Carbohydrates', 'Potassium Rich', 'Freshly Harvested'],
      healthScore: 9.1,
      healthyChoice: true,
      storage: 'Keep in a cool, dark, well-ventilated area.',
    },
    {
      category: 'Vegetables & Fruits',
      subCategory: 'fresh-vegetables',
      ...
      price: 38,
      mrp: 42,
      barcode: '890126209003',
      sku: 'SKU-VEG-ONION-1KG',
      imageFile: '02df8262-1ccc-4078-a215-991a85ded7b0.png',
      description: 'Pungent and flavorful Nashik red onions, indispensable for Indian cooking.',
      aiBenefits: ['Antioxidant Quercetin', 'Immunity Booster', 'Pungent Flavor Profile'],
      healthScore: 9.3,
      healthyChoice: true,
      storage: 'Store in open dry mesh bag.',
    },
    {
      category: 'Vegetables & Fruits',
      subCategory: 'fresh-vegetables',
      ...
      price: 36,
      mrp: 40,
      barcode: '890126209005',
      sku: 'SKU-VEG-CAPS-250G',
      imageFile: '079cdbf5-0e6e-4de4-ad0a-447e56ae8016.png',
      description: 'Crunchy, vibrant green capsicums perfect for stir-fries, salads, and pizza toppings.',
      aiBenefits: ['Vitamin C Powerhouse', 'Low Calorie Snack', 'Crispy & Tender'],
      healthScore: 9.6,
      healthyChoice: true,
      storage: 'Refrigerate in vegetable crisper drawer.',
    },
    {
      category: 'Vegetables & Fruits',
      subCategory: 'fresh-vegetables',
      ...
      price: 22,
      mrp: 25,
      barcode: '890126209006',
      sku: 'SKU-VEG-SPINACH-250G',
      imageFile: '083c2cf1-36a0-4328-98a1-fbe6e0ec1d0a.png',
      description: 'Washed, tender hydroponic spinach leaves rich in iron, folate, and vitamins.',
      aiBenefits: ['Iron & Folate Rich', 'Pre-Washed & Ready to Cook', 'Superfood Green'],
      healthScore: 9.8,
      healthyChoice: true,
